...
--   ADDED: cms_settings table with JSONB customization data
--   ADDED: cms_settings_versions table for version history and rollback
--   ADDED: cms_audit_log table for compliance and troubleshooting
--   ADDED: theme_presets table for pre-configured templates
...
--   7.  CMS customization tables (cms_settings, cms_settings_versions, cms_audit_log, theme_presets)
--   8.  Audit & governance tables
--   9.  Email system tables
--   10. Indexes (base + normalized + cms)
--   11. Row-Level Security
--   12. Carried-over tables (instructors, lendings, etc.)
--   13. Platform auth tables
--   14. Enforcement triggers (registration, enrollment, attendance)
--   15. Audit logging functions
--   16. Helper & validation functions
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS programs (
  ...
  type_of_funding VARCHAR(255)  NOT NULL DEFAULT 'Not Specified',
...
-- =============================================================================
-- CMS SETTINGS TABLE (Main Configuration Store)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS cms_settings (
  ...
  -- JSONB structure containing landing page content
  -- Simplified to focus on: appearance (logo, heroBackground), hero, mission, vision, features, CTA, contact, footer
...
-- =============================================================================
-- CMS SETTINGS VERSIONS TABLE (Version History for Rollback)
-- =============================================================================

-- Tracks configuration history for rollback and versioning
...
-- =============================================================================
-- CMS AUDIT LOG TABLE (Audit Trail for Compliance)
-- =============================================================================

-- Tracks all customization changes for compliance and troubleshooting
CREATE TABLE IF NOT EXISTS cms_audit_log (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tenant_id UUID NOT NULL,
  admin_id UUID,
  
  -- Action type: create, update, delete, import, rollback
  action VARCHAR(50) NOT NULL
    CHECK (action IN ('create', 'update', 'delete', 'import', 'rollback')),
...
-- =============================================================================
-- THEME PRESETS TABLE (Pre-Configured Theme Templates)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS theme_presets (
  ...
  name VARCHAR(255) NOT NULL,
  description TEXT,
  category VARCHAR(100), -- e.g., "modern", "corporate", "creative", "bold"
...
-- Index for efficient preset queries
...
-- =============================================================================
-- DATABASE TRIGGER: Automatic CMS Settings Update Timestamp
-- =============================================================================

-- This trigger ensures cms_settings.updated_at is automatically updated
-- whenever the settings_data JSONB is modified
DROP TRIGGER IF EXISTS trigger_cms_settings_updated_at ON cms_settings;
CREATE TRIGGER trigger_cms_settings_updated_at
  BEFORE UPDATE ON cms_settings
  FOR EACH ROW
...
-- =============================================================================
-- HELPER FUNCTION: Initialize CMS Settings for Existing Tenants
-- =============================================================================
...
-- 6. Added: 4 CMS customization tables (cms_settings, versions, audit_log, theme_presets)
-- 7. Added: Comprehensive trigger enforcement and audit logging
-- 8. Added: 20 performance indexes
--
-- Next steps:
...
-- 4. Initialize CMS settings for existing tenants (via initialize_cms_settings_for_existing_tenants())
-- 5. Update backend services to use normalized and CMS tables
--
-- =============================================================================
...
-- =============================================================================
-- Training Requirement Files Table
-- Stores training requirement file uploads with tenant isolation
-- =============================================================================
