...
export const GET = withErrorHandler(async (request: NextRequest) => {
  ...
  // Try trainee_accounts first, then fall back to trainees.user_id

let trainee: { id: string; first_name: string; last_name: string } | null = null;
  ...
  if (traineeAccount?.trainees) {
    trainee = traineeAccount.trainees as { id: string; first_name: string; last_name: string };
  } else {
